function mudar_cor(){
    var icone = window.document.getElementById('icone')

    $(icone).append('<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-volume-mute-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
